  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 sm:w-80 md:w-96 h-64 sm:h-80 md:h-96 bg-gradient-to-r from-purple-400/10 to-pink-400/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>

      <div className="max-w-5xl w-full py-6 sm:py-10 relative z-10">
        <div className="backdrop-blur-xl bg-white/10 p-6 sm:p-10 rounded-3xl shadow-2xl max-w-3xl w-full mx-auto space-y-10 border border-white/20">
          {/* Header with animated gradient text */}
          <div className="text-center space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent animate-pulse">
              Daily Flirt
            </h1>
          ...
          {currentComment && (
            <div className="relative group">
              ...
              <div className="relative p-6 sm:p-8 border-2 border-white/30 rounded-3xl bg-white/10 backdrop-blur-xl shadow-2xl w-full transform transition-all duration-500 hover:scale-[1.02]">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-pink-400 to-purple-400 rounded-full flex items-center justify-center text-xl sm:text-2xl">
                    💬
                  </div>
                  <div className="flex-1">
                    <p className="text-xl sm:text-2xl text-white font-bold leading-relaxed mb-4">
          ...
          {!currentComment && (
            <div className="text-center p-6 sm:p-8 border-2 border-red-400/30 rounded-3xl bg-red-500/10 backdrop-blur-sm">
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 space-y-4 z-20">
        <button 
          onClick={handleCopyToClipboard}
          disabled={!currentComment}
          className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full shadow-2xl flex items-center justify-center text-white text-xl sm:text-2xl hover:scale-110 transition-all duration-300 transform hover:-translate-y-1 ${
            currentComment 
        ...
        <button 
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full shadow-2xl shadow-purple-500/50 flex items-center justify-center text-white text-xl sm:text-2xl hover:scale-110 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-purple-500/70"
      ...
      {showAgeVerification && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="backdrop-blur-xl bg-white/10 p-6 sm:p-10 rounded-3xl shadow-2xl max-w-md w-full border border-white/20 text-center">
            <div className="space-y-6">
      ...
      {/* Feedback messages */}
      {showCopiedMessage && (
        <div className="fixed top-4 right-4 sm:top-8 sm:right-8 z-30">
      ...
      {showCountdown && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="backdrop-blur-xl bg-white/10 p-6 sm:p-8 rounded-3xl shadow-2xl max-w-md w-full border border-white/20 text-center">
            <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-white font-mono">
              {countdown}
            </div>
          </div>
        </div>
